...
public class R<T> implements Serializable {
    ...
    public static <T> R<T> status(boolean flag) {return flag ? success("操作成功") : fail("操作失败"); }
    public int getCode() {
        return this.code;
    }
    ...
    public static final Key KEY = new SecretKeySpec("zucc".getBytes(), io.jsonwebtoken.SignatureAlgorithm.HS512.getJcaName());
